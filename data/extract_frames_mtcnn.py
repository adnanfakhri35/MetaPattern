...
import sys
# sys.path.append('mxnet_mtcnn_face_detection') # You need to configure the path based on your installed MTCNN
...
ROOT_DIR = 'root_data' # Where you save the raw data you download
SAVE_DIR = 'save_data' # Where you want to save the processed data
